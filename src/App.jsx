        ...
        <div className="mt-15 mx-auto w-full max-w-[1600px] rounded-3xl border-[5px] border-violet-500/40 shadow-[0_0_30px_rgba(168,85,247,0.4)] bg-gradient-to-br from-[#0a0a0a] via-[#111111] to-[#1a1a1a] p-6" id="about" ref={aboutRef}>
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 pt-0 px-8" data-aos="fade-up">
            <div className="basis-full md:basis-7/12 pr-0 md:pr-8 border-b md:border-b-0 md:border-r border-violet-500/30">
              ...
              <BlurText
                text="I’m Muhammad Rizki, An active college student in Teknik Informatika at Universitas Bina Sarana Informatika, focusing on developing future technology skills. Starting my journey in the world of technology at the age of 17, I am passionate about exploring and working with AI."
                delay={150}
                animateBy="words"
                direction="top"
